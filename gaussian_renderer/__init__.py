...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, stage="fine", render_img_size=None, equirec_flag=False):
    """
    Render the scene. 
